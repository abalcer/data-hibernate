...
('departmentEmployees',      9,'4b315afa0e35ca6649df897b958345bcb3d2b764',
...
INSERT INTO tchecksum 
    ...
    FROM departmentEmployees ORDER BY dept_no;
INSERT INTO found_values values ('departmentEmployees', (SELECT COUNT(*) FROM departmentEmployees), @crc,@crc);
